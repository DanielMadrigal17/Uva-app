...
const Login = ({ setCurrUser, setShow }) => {
 ...
 return (
    <div className="login-div">
      ...
      <p className='login-eslogan'> UVA App, organiza y administra <br />
        tu empresa de la mejor manera. </p>

      <div className="login-card">
        <div className="login-card2">
          <form ref={formRef} onSubmit={handleSubmit} className="form1">
            ...
            <div className="login-field">
              ...
              <input className="login-input-field" type="email" name='email' placeholder="email" />
            </div>
            <div className="login-field">
              <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg" className="input-icon">
                <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
              </svg>
              <input className="login-input-field" type="password" name='password' placeholder="password" />
            </div>
