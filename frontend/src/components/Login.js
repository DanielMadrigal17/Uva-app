...
const Login = ({ setCurrUser, setShow }) => {
 ...
 return (
    <div>
      ...
      <img className='uvaLogo' src={uva} alt='uva logo' />
      ...
      <div className="card">
        <div className="card2">
          <form ref={formRef} onSubmit={handleSubmit} className="form1">
            ...
            <div className="btn">
              <button className="button2" type='submit' value="Login">Ingresar</button>
              <button className="button2" onClick={handleClick}>Registrarse</button>
            </div>
